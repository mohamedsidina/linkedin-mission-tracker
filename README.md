...
3. Wait 3–5 minutes
4. Open your Google Sheet → **Missions** tab should have results

> If it fails, click the failed run → download the **run-logs** artifact → open the `.log` file to see the exact error.
